...
describe('list', () =>
{
	...
	test
		...
		.stdout()
		.command(['list'])
		.it('should show no mods installed if manager is empty', context =>
		{
			expect(context.stdout).to.contain('No mods installed');
		});
	...
	test
		...
		.stdout()
		.command(['list'])
		.it('should show installed mods details', context =>
		{
